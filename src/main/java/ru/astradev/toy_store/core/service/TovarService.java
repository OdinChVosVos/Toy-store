...
import ru.astradev.toy_store.api.job.ImageUtils;
...
import ru.astradev.toy_store.db.repository.ArchiveTrashRepository;
...
//        tovarRepository.saveAndFlush(existingTovar);
    ...
    public void photos() throws IOException {
        for (int i = 1; i<10; i++){
            File file = new File("/src/main/resources/static/imgs/goods/"+i+".png");
